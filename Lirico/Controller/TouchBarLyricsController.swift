...
class TouchBarLyricsController: TouchBarSystemModalController {
    ...
    override func touchBarDidLoad() {
        ...
        let trayImage = NSImage(systemSymbolName: "music.note", accessibilityDescription: "Lirico") ?? NSImage()
...
extension NSTouchBarItem.Identifier {
    fileprivate static let lyrics = NSTouchBarItem.Identifier("com.fabiogaliano.Lirico.touchBar.lyrics")
    fileprivate static let currentArtwork = NSTouchBarItem.Identifier("com.fabiogaliano.Lirico.touchBar.currentArtwork")
    fileprivate static let playbackControl = NSTouchBarItem.Identifier("com.fabiogaliano.Lirico.touchBar.playbackControl")

    fileprivate static let systemTrayItem = NSTouchBarItem.Identifier("com.fabiogaliano.Lirico.touchBar.systemTrayItem")
}

extension NSTouchBar.CustomizationIdentifier {
    static let main = NSTouchBar.CustomizationIdentifier("com.fabiogaliano.Lirico.touchBar.customization.main")
}
